                ...
                builder.setItems(items, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int item) {
                        if (items[item].equals("Allopathic Doctor")) {
                            ...
                            acTextView.setAdapter(new SuggestionAdapter3(Otp.this, acTextView.getText().toString()));
...
*/
                           auto = (MultiAutoCompleteTextView) mView.findViewById(R.id.subspeciality);
                            ...
                            auto.setThreshold(1);
                            auto.setAdapter(new SuggestionAdapter33(Otp.this, auto.getText().toString()));
                                        ...
                                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                            public void onClick(DialogInterface dialogBox, int id) {
                                                ...
                                                if (TextUtils.isEmpty(Inputuser.getText().toString())) {
                                                    ...
                                                    Toast.makeText(c, "Please Enter Username.", Toast.LENGTH_LONG).show();
                                                    Inputuser.requestFocus();
                                                    return;


                                                }
                                                else if (TextUtils.isEmpty(pwText.getText().toString())) {
                                                    ...
                                                    repwText.setError("Please Enter Confirm Password.");
                                                    Toast.makeText(c, "Please Enter Confirm Password.", Toast.LENGTH_LONG).show();
...
//Hi 
                        ...
                        else if (items[item].equals("Ayush Medicine Practitioner"))
                        {
                            ...
                            repwText = (PasswordEditText) mView.findViewById(R.id.input_password2);
                            acTextView = (AutoCompleteTextView) mView.findViewById(R.id.userInputDialog);
                            acTextView.setAdapter(new SuggestionAdapter4(Otp.this, acTextView.getText().toString()));
                            /*AutoCompleteTextView acTextView = (AutoCompleteTextView) findViewById(R.id.userInputDialog);
                            acTextView.setAdapter(new SuggestionAdapter(Otp.this,acTextView.getText().toString()));
*/
                            auto = (MultiAutoCompleteTextView) mView.findViewById(R.id.subspeciality);
                            ...
                            auto.setTokenizer(new MultiAutoCompleteTextView.CommaTokenizer());
                            auto.setThreshold(1);
                            auto.setAdapter(new SuggestionAdapter44(Otp.this, auto.getText().toString()));
...
//Hi
                            ...
                            repwText = (PasswordEditText) mView.findViewById(R.id.input_password2);
                            acTextView = (AutoCompleteTextView) mView.findViewById(R.id.userInputDialog);
                            acTextView.setAdapter(new SuggestionAdapter5(Otp.this, acTextView.getText().toString()));
                            /*AutoCompleteTextView acTextView = (AutoCompleteTextView) findViewById(R.id.userInputDialog);
                            acTextView.setAdapter(new SuggestionAdapter(Otp.this,acTextView.getText().toString()));
*/
                            auto = (MultiAutoCompleteTextView) mView.findViewById(R.id.subspeciality);
                            ...
                            auto.setTokenizer(new MultiAutoCompleteTextView.CommaTokenizer());
                            auto.setThreshold(1);
                            auto.setAdapter(new SuggestionAdapter55(Otp.this, auto.getText().toString()));
...
//Hi
                            ...
                            repwText = (PasswordEditText) mView.findViewById(R.id.input_password2);
                            acTextView = (AutoCompleteTextView) mView.findViewById(R.id.userInputDialog);
                            acTextView.setAdapter(new SuggestionAdapter6(Otp.this, acTextView.getText().toString()));

                            auto = (MultiAutoCompleteTextView) mView.findViewById(R.id.subspeciality);
                            auto.setTokenizer(new MultiAutoCompleteTextView.CommaTokenizer());
                            auto.setThreshold(1);
                            auto.setAdapter(new SuggestionAdapter66(Otp.this, auto.getText().toString()));
...
//Hi
                            ...
                            repwText = (PasswordEditText) mView.findViewById(R.id.input_password2);
                            acTextView = (AutoCompleteTextView) mView.findViewById(R.id.userInputDialog);
                            acTextView.setAdapter(new SuggestionAdapter7(Otp.this, acTextView.getText().toString()));

                            auto = (MultiAutoCompleteTextView) mView.findViewById(R.id.subspeciality);
                            auto.setTokenizer(new MultiAutoCompleteTextView.CommaTokenizer());
                            auto.setThreshold(1);
                            auto.setAdapter(new SuggestionAdapter77(Otp.this, auto.getText().toString()));
...
//Hi
                            ...
                            repwText = (PasswordEditText) mView.findViewById(R.id.input_password2);
                            acTextView = (AutoCompleteTextView) mView.findViewById(R.id.userInputDialog);
                            acTextView.setAdapter(new SuggestionAdapter8(Otp.this, acTextView.getText().toString()));

                            auto = (MultiAutoCompleteTextView) mView.findViewById(R.id.subspeciality);
                            auto.setTokenizer(new MultiAutoCompleteTextView.CommaTokenizer());
                            auto.setThreshold(1);
                            auto.setAdapter(new SuggestionAdapter88(Otp.this, auto.getText().toString()));
